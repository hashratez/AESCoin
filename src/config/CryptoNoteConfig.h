...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xe49;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(147570000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "011401ff00018081eedea50402c2b8d99bf1e2fd1b62f88479b8e300beedcc49a6e07d62c7cd87a3167008199921019bb7fc7ba387b59b90cf46015cce983267ca63200b64e85ce49edf9de82ba64b";

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1538220175;
...
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 20000000;
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 30000000;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 60; // Upgrade height for CN-Lite Variant 1 switch.
...
const char     CRYPTONOTE_NAME[]                             = "AEScoin";
...
const char     LATEST_VERSION_URL[]                          = "https://aescoin.io";
...
const char* const SEED_NODES[] = {
  ...
  "node4.aescoin.io:18111", //node4
  "lax1.aescoin.io:18111", //lax1
  "dfw1.aescoin.io:18111", //dfw1
  "ord1.aescoin.io:18111", //ord1
  "ny1.aescoin.io:18111", //ny1 
};
} // CryptoNote
